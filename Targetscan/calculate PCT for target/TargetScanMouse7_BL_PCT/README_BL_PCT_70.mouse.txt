...
TargetScanMouse files are different from those for TargetScanHuman.
...
This script also requires a directory called "PCT_parameters" containing the following file:
	Tree.generic.txt
This is a tree file describing the phylogeny of all TargetScanMouse 7 species as defined by the conservation of their UTRs.
...
(from http://www.targetscan.org/cgi-bin/targetscan/data_download.cgi?db=mmu_70) and for each group 
